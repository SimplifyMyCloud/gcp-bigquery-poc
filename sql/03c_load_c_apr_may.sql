-- Strategy C Chunk 2: Apr 19 – May 23 (35 days × 96 partitions/day = 3,360)
...
WHERE timestamp >= TIMESTAMP '2025-04-19 00:00:00 UTC'
  AND timestamp < TIMESTAMP '2025-05-24 00:00:00 UTC';
